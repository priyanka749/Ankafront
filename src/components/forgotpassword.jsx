      ...
      <div className="bg-[#FFFBF7] rounded-xl shadow-2xl px-10 py-14 w-full max-w-xl text-center space-y-8 border border-[#FFFBF7]">
        ...
        {step === 1 && (
          <>
            ...
            />
            <button
              className="px-10 py-2 bg-[#8B6B3E] text-white font-semibold rounded-md hover:bg-[#A47E50]"
            ...
            <div className="flex justify-center gap-3">
              {otp.map((val, idx) => (
                <input
                  ...
                  className="w-12 h-12 border border-gray-400 rounded-md text-center text-lg focus:outline-none focus:ring-2 focus:ring-[#8B6B3E]"
                />
              ))}
            </div>
            <button
