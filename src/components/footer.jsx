...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#8B6B3E] text-white pt-3 pb-1 px-4 md:px-10">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0 py-2">
        ...
        <div className="flex flex-col items-end gap-2 min-w-[200px]">
          <button
            className="bg-[#e2c799] text-[#8B6B3E] px-7 py-2 rounded-full font-semibold shadow hover:bg-white hover:text-[#8B6B3E] transition text-base"
