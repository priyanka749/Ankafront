...
const NewArrivals = () => {
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-white via-[#fdf9f6] to-[#EBDECD] text-[#8B6B3E]">
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-[#8B6B3E] mx-auto mb-4"></div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-white via-[#fdf9f6] to-[#EBDECD] text-[#8B6B3E] relative overflow-hidden">
      <Navbar />
      <FloatingElements />
      <ToastContainer
        position="top-center"
      ...
      <div className="relative bg-gradient-to-r from-[#fdf6e3] via-[#f7e9d0] to-[#e2c799] py-12 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <div className="relative mb-6">
            <div className="flex justify-center">
              <div className="inline-flex items-center gap-3 bg-white/40 backdrop-blur-sm rounded-full px-6 py-2 animate-bounce">
                <FaFire className="text-[#8B6B3E] animate-pulse" />
                <span className="font-semibold text-sm tracking-wide text-[#8B6B3E]">JUST DROPPED</span>
              </div>
            </div>
            <div className="absolute top-0 right-0 flex items-center gap-2 bg-white/80 px-5 py-1 rounded-full border border-[#8B6B3E] shadow">
              <input
                type="text"
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                placeholder="Search..."
                className="bg-transparent text-[#8B6B3E] focus:outline-none text-sm px-2"
                style={{ minWidth: 120 }}
              />
              <span className="text-[#8B6B3E]">
          ...
          <h1 className="text-5xl sm:text-7xl font-bold mb-6 text-[#8B6B3E]">
            New Arrivals
          </h1>
          <p className="text-xl sm:text-2xl opacity-90 mb-8 max-w-2xl mx-auto leading-relaxed text-[#8B6B3E]">
              ...
              {filtered.map((product) => (
                ...
                >
                  ...
                  <div className="absolute top-2 left-2 z-20">
                    <div className="bg-[#c7a24a] text-white px-4 py-2 rounded text-base font-semibold shadow-md" style={{fontFamily: 'Poppins, sans-serif'}}>New</div>
                  </div>
                  ...
                  <div className="p-4 bg-gradient-to-t from-amber-50/50 to-white flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-center gap-2 pt-3">
                      ...
                      <button
                        className="w-1/2 bg-[#8B6B3E] text-white py-1 rounded-full font-medium hover:bg-[#704F2E] transition-colors duration-200"
