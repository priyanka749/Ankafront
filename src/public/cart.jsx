...
const ConfirmPopover = ({ anchorRef, onConfirm, onCancel }) => {
  ...
  return (
    ...
    >
      <div className="text-center text-[#8B6B3E] font-semibold text-base mb-6 leading-snug">
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#f9f6f1] to-[#f3e9db] relative">
      ...
      <div className="flex-2 w-full max-w-9xl mx-auto py-12 px-8 flex flex-col lg:flex-row gap-10">
            ...
            cart.map((item) => (
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-center h-full">
                  <div>
                    <h2 className="text-xl font-bold text-[#8B6B3E] mb-0.5 line-clamp-1">{item.title}</h2>
                    <p className="text-sm font-normal text-[#8B6B3E] mb-1 line-clamp-1">{item.desc}</p>
                    <div className="flex flex-col gap-1 mt-1">
                      <div className="flex items-center gap-1 text-lg">
                        <span className="font-semibold text-[#8B6B3E]">Price:</span>
                        <span className="text-emerald-600 font-semibold">Rs {item.price}</span>
                      </div>
                      {item.color && (
                        <div className="flex items-center gap-2 text-sm">
                          <span className="font-semibold text-[#8B6B3E]">Color:</span>
                          <span
                      ...
                      {item.size && (
                        <div className="text-sm">
                          <span className="font-semibold text-[#8B6B3E]">Size:</span>{' '}
                          <span className="font-semibold text-[#8B6B3E]">{item.size}</span>
                        </div>
                      )}
                      {item.outOfStock && (
                ...
                <div className="flex flex-col items-end justify-between h-full gap-2 min-w-[120px]">
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    <button
                      ...
                      className="w-9 h-9 rounded-full border-2 border-[#e2c799] text-xl font-bold text-[#8B6B3E] bg-white hover:bg-[#f9f6f2] transition flex items-center justify-center"
        ...
        <div className="w-full max-w-[440px] mx-auto lg:mx-0 bg-white rounded-3xl shadow-2xl border border-[#e2c799] p-10 flex flex-col gap-8 self-start mt-8 lg:mt-0 min-h-[420px]">
          <div className="text-2xl font-bold text-[#8B6B3E] mb-2">Order Summary</div>
          ...
          <div className="flex flex-col gap-4 mt-4">
            {/* <button className="w-full bg-[#e2c799] text-[#8B6B3E] font-bold py-5 rounded-xl shadow hover:bg-[#f3e9db] transition text-lg min-h-[60px]">
              Cash on Delivery
            </button> */}
           <button className="w-full bg-[#e2c799] text-[#8B6B3E] font-bold py-5 rounded-xl shadow hover:bg-[#f3e9db] transition text-lg min-h-[60px]" onClick={handleOnlinePayment}>
              Online Payment
            </button>
          </div>
        </div>
