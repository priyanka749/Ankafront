  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-white via-[#fdf9f6] to-[#EBDECD] text-[#8B6B3E]">
      ...
      <div className="bg-[#FFF9F3] shadow-md px-7 py-10">
        <div className="w-full max-w-4xl mx-auto flex items-center gap-3 bg-white border-2 border-[#8B6B3E] rounded-full px-6 py-3 shadow-lg">
          <svg className="w-5 h-5 text-[#8B6B3E]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
