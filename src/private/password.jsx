  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fdf6ee]">
      <div className="w-full max-w-md mx-auto bg-[#fff7ec] p-8 rounded-3xl shadow">
        <h2 className="text-2xl font-bold mb-6 text-[#8B6B3E] text-center">Change Password</h2>
        <form onSubmit={handlePasswordChange} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full mt-4 bg-[#8B6B3E] text-white py-2 px-6 rounded-full hover:bg-[#B0895E]"
          >
            Update Password
          </button>
        </form>
