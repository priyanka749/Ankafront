            ...
            {favorites.map((fav) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <button
                    className="absolute top-2 right-2 text-[#8B6B3E] hover:text-rose-600 transition-colors duration-200 bg-white rounded-full p-1 shadow-md"
                    onClick={(e) => {
                      e.stopPropagation();
